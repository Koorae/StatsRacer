namespace CarComponents.CarEffects
{
    ...
    public class AccelerationSounds : CarPart
    {
        #region Fields
        ...
        void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax,
                    car.engine.currentRPM / car.engine.maxRPM);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(carControl.AccelInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    // float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarEffects.Revs);
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, car.engine.currentRPM
                        / car.engine.maxRPM);
